...
class TestLib(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.csv_url = "https://raw.githubusercontent.com/fivethirtyeight/data/refs/heads/master/alcohol-consumption/drinks.csv"
    ...
    def test_load_and_preprocess(self):
        ...
        self.assertEqual(self.df.shape[1], 6, "The DataFrame should have 6 columns after renaming")
    ...
    def test_compute_correlation_matrix(self):
        ...
        self.assertEqual(corr_matrix.shape, (4, 4), "Correlation matrix should be 4x4")
        self.assertTrue((corr_matrix >= -1).all().all() and (corr_matrix <= 1).all().all(), "Correlation values should be between -1 and 1")
    ...
    def test_classify_and_count_categories(self):
        ...
        self.assertIn("consumption_category", classified_df.columns, "Consumption category column missing")
        self.assertTrue(classified_df['consumption_category'].isin(['Low', 'Moderate', 'High']).all(), "Invalid category labels")
